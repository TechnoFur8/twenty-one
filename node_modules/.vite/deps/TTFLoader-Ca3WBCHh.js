import { Ir as Loader, dn as FileLoader } from "./three.core-CFODPNnR.js";
//#region node_modules/three/examples/jsm/libs/opentype.module.js
/**
...
function makeColrTable(ref) {
	...
	].concat(baseGlyphRecords.map(function(glyph, i) {
		return [
			{
				name: "glyphID_" + i,
				type: "USHORT",
	...
	}).flat(), layerRecords.map(function(layer, i) {
		return [{
...
function parseCpalTable(data, start) {
	...
	return {
		version,
		numPaletteEntries,
		colorRecords: p.parseULongList(numColorRecords),
		colorRecordIndices
	};
}
function makeCpalTable(ref) {
	...
	].concat(colorRecordIndices.map(function(palette, i) {
		return {
...
function fontToSfntTable(font) {
	...
	if (font.tables.cpal) tables.push(cpal.make(font.tables.cpal));
	if (font.tables.colr) tables.push(colr.make(font.tables.colr));
...
//#endregion
//#region node_modules/three/examples/jsm/loaders/TTFLoader.js
/**
			...
			for (let i = 0; i < unicodes.length; i++) {
				...
				if (unicode !== void 0) {
					...
					glyph.path.commands.forEach(function(command) {
						...
						if (command.x !== void 0 && command.y !== void 0) token.o += round(command.x * scale) + " " + round(command.y * scale) + " ";
						if (command.x1 !== void 0 && command.y1 !== void 0) token.o += round(command.x1 * scale) + " " + round(command.y1 * scale) + " ";
						if (command.x2 !== void 0 && command.y2 !== void 0) token.o += round(command.x2 * scale) + " " + round(command.y2 * scale) + " ";
					});
					if (Array.isArray(glyph.unicodes) && glyph.unicodes.length > 0) glyph.unicodes.forEach(function(unicode) {
						glyphs[String.fromCodePoint(unicode)] = token;
					});
					else glyphs[String.fromCodePoint(glyph.unicode)] = token;
				}
			}
			return {
				glyphs,
...
//#endregion
export { TTFLoader as t };

//# sourceMappingURL=TTFLoader-Ca3WBCHh.js.map